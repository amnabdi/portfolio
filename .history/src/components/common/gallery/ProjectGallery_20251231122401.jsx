  ...
  return (
    <div>
      ...
      >
        ...
        <div
          ref={prevRef}
          className="absolute top-1/2 left-2 z-10 -translate-y-1/2 cursor-pointer text-white "
        >
          {/* میتونی اینجا آیکون دلخواه بذاری */}◀
        </div>
        <div
          ref={nextRef}
          className="absolute top-1/2 right-2 z-10 -translate-y-1/2 cursor-pointer text-white "
        >
          ▶
        </div>
      </Swiper>
